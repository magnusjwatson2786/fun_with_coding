...
public void createGUI(){
  ...
  slider1 = new GSlider(window1, 174, 60, 268, 40, 10.0);
  ...
  slider2 = new GSlider(window1, 174, 79, 269, 40, 10.0);
  ...
  slider3 = new GSlider(window1, 174, 98, 269, 40, 10.0);
  ...
  slider4 = new GSlider(window1, 19, 201, 210, 40, 10.0);
  slider4.setShowValue(true);
  slider4.setLimits(20.0, 5.0, 100.0);
